...
function loadTechnicians() {
  ...
  localStorage.removeItem('central_technicians');

  // Initialize complete technicians for Central region (matches config.js)
  const defaultTechs = [
    { id: 9, name: 'Darren Ramjit', status: 'Available', location: 'Chaguanas', iconColor: 'blue' },
    { id: 10, name: 'Kavita Patel', status: 'Dispatched', location: 'Couva', iconColor: 'red' },
    { id: 11, name: 'Marcus Baptiste', status: 'Available', location: 'Freeport', iconColor: 'blue' },
    { id: 12, name: 'Sunita Ramnarine', status: 'On-route', location: 'Cunupia', iconColor: 'red' }
  ];

  // Save complete data to local storage for future sessions
